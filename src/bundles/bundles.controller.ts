...
export class BundlesController {
  ...
  async createBundle(@Body() body: any, @Request() req: any) {
    return this.service.createBundle(
      body,
  ...
  async updateBundle(
    ...
    return this.service.updateBundle(
      BigInt(id),
      body,
      req.user.workspace_id || 1,
    );
  ...
  async shareBundle(
    ...
    return this.service.shareBundle(
      BigInt(id),
      req.user.workspace_id || 1,
      body,
    );
  ...
  async deleteBundleSharing(
    @Param('share_id') shareId: string,
    @Request() req: any,
  ) {
    return this.service.deleteBundleSharing(
      BigInt(shareId),
      req.user.workspace_id || 1,
    );
  }
  ...
  async verifyPasscode(
    @Param('share_id') shareId: string,
    @Body('pass_code') passcode: string,
  ) {
