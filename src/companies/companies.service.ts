...
export class CompaniesService {
    ...
    async createNew(workspaceId: bigint, userId: bigint, data: any) {
        ...
        if (data.company_id) {
            ...
            if (!companyName) throw new BadRequestException('Company name or contact name is required');
    ...
    async updateCompany(workspaceId: bigint, companyId: bigint, data: any) {
        const { name, description, url, industry, tax_id, gallery_media_id, status } = data;
        ...
        const updated = await this.prisma.companies.update({
            ...
            data: {
                ...
                industry,
                tax_id,
                gallery_media_id: gallery_media_id ? BigInt(gallery_media_id) : undefined,
     ...
     */
    async assignCompany(workspaceId: bigint, contactId: bigint, companyId: bigint) {
